...
(function(){
  var BV_CSS=[
    ...
    '.bv-header,.bv-header *{font-family:ki,sans-serif!important}',
    '.bv-header .font-heading,.bv-header .bv-nav-link,.bv-header .bv-nav-link .btn-text,.bv-header .btn-text-cta,.bv-header .bv-sep{font-family:teknolog,sans-serif!important}',
    '.bv-site-footer,.bv-site-footer *{font-family:ki,sans-serif!important}',
