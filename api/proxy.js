...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    ${slug === 'careers' ? 'body{padding-top:0!important;}#wix-wrap{height:2450px;margin-top:100px;}@media(max-width:767px){#wix-wrap{height:1300px;margin-top:80px;}#wix-frame{top:-30px;height:calc(100% + 30px);}}' : ''}
