        ...
        <div class="bv-site-footer__grid">
          <div class="bv-site-footer__brand">
            ...
            <div class="footer-social-links">
              <a href="mailto:info@brainvoiceai.com" target="_blank" rel="noopener noreferrer" class="bv-social-btn" aria-label="Email"><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"/></svg></a>
              <a href="https://www.instagram.com/brainvoice.ai?igsh=bmtmYWFkZm40cnpm" target="_blank" rel="noopener noreferrer" class="bv-social-btn" aria-label="Instagram"><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg></a>
              <a href="https://www.linkedin.com/company/brainvoice-ai/" target="_blank" rel="noopener noreferrer" class="bv-social-btn" aria-label="LinkedIn"><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/></svg></a>
              <a href="https://youtube.com/@ai_strategylab?si=iHq4umKvQk35Z49v" target="_blank" rel="noopener noreferrer" class="bv-social-btn" aria-label="YouTube"><svg viewBox="0 0 24 24" width="16" height="16" fill="currentColor"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg></a>
            </div>
          </div>
...
(function(){
  ...
  css.textContent=[
    ...
    '.bv-site-footer__tagline{font-size:0.75rem;line-height:1.4;color:#315e60;margin:0}',
    ...
    '.bv-site-footer__links a{font-size:0.7rem;text-decoration:none;color:#2d6668;text-transform:uppercase;letter-spacing:0.04em;white-space:nowrap}',
...
function buildFAQSection() {
  const faqs = [
    { q: 'What services does Brainvoice.AI offer?', a: 'We offer digital marketing, web development, IT consulting, software development, and digital transformation services tailored to your business needs.' },
    { q: 'How can I get started with Brainvoice.AI?', a: 'Simply reach out to us via email, phone, or schedule a demo. Our team will assess your requirements and create a customized plan for your business.' },
    { q: 'What industries do you serve?', a: 'We serve a wide range of industries including healthcare, finance, retail, education, and technology, providing customized solutions for each sector.' },
    { q: 'How long does a typical project take?', a: 'Project timelines vary based on scope and complexity. A typical website project takes 4-8 weeks, while larger digital transformation projects may take 3-6 months.' },
    { q: 'Do you provide ongoing support?', a: 'Yes, we offer comprehensive post-launch support and maintenance packages to ensure your digital solutions continue to perform optimally.' },
  ];
  return `
...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box;}
    ...
    #wix-wrap{overflow:hidden;position:relative;z-index:1;background:white;}
    ${slug === 'about' ? '#wix-wrap{height:5450px;}@media(max-width:767px){#wix-wrap{height:7990px;}}' : ''}
    ${slug === 'careers' ? '#wix-wrap{height:2900px;margin-top:80px;}@media(max-width:767px){#wix-wrap{height:1350px;margin-top:20px;}#bv-header{padding-bottom:0!important;}}' : ''}
    ${slug === 'get-started' ? '#wix-wrap{height:3150px;}@media(max-width:767px){#wix-wrap{height:1100px;}}' : ''}
...
<body>
  ...
  ${slug === 'get-started' ? '<div class="bv-mobile-only-sections" style="display:none;">' + buildFAQSection() + buildMapSection() + '</div><style>@media(max-width:767px){.bv-mobile-only-sections{display:block!important;}}</style>' : ''}
